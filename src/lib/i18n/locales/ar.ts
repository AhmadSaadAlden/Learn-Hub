...
const ar = {
    ...
    courses: {
        1: { imgTitle: "التصوير", description: "بواسطة ديتيرميد بويتراس", title: "إنشاء موقع LMS باستخدام LearnPress", free: "مجاني", viewMore: "عرض المزيد" },
        2: { imgTitle: "التصميم", description: "بواسطة استوديو إبداعي", title: "أساسيات تصميم UI/UX", free: "مدفوع", viewMore: "عرض المزيد" },
        3: { imgTitle: "التسويق", description: "بواسطة خبراء رقميين", title: "استراتيجيات التسويق الرقمي", free: "مدفوع", viewMore: "عرض المزيد" },
        4: { imgTitle: "علوم البيانات", description: "بواسطة علماء بيانات", title: "بايثون لتحليل البيانات", free: "مدفوع", viewMore: "عرض المزيد" },
        5: { imgTitle: "الأعمال", description: "بواسطة قادة الأعمال", title: "ريادة الأعمال 101", free: "مدفوع", viewMore: "عرض المزيد" },
        6: { imgTitle: "التصوير", description: "بواسطة مصورين محترفين", title: "تقنيات التصوير المتقدمة", free: "مدفوع", viewMore: "عرض المزيد" },
        7: { imgTitle: "تطوير الويب", description: "بواسطة أساتذة التقنية", title: "برمجة JavaScript متقدمة", free: "مدفوع", viewMore: "عرض المزيد" },
        8: { imgTitle: "اللغات", description: "بواسطة خبراء لغات", title: "الإسبانية للمبتدئين", free: "مدفوع", viewMore: "عرض المزيد" },
        9: { imgTitle: "الموسيقى", description: "بواسطة أساتذة موسيقى", title: "أساسيات العزف على الجيتار", free: "مدفوع", viewMore: "عرض المزيد" },
        10: { imgTitle: "الصحة", description: "بواسطة مدربي لياقة", title: "التغذية والعافية", free: "مدفوع", viewMore: "عرض المزيد" },
        11: { imgTitle: "تكنولوجيا المعلومات", description: "بواسطة محترفي IT", title: "أساسيات أمن الشبكات", free: "مدفوع", viewMore: "عرض المزيد" },
        12: { imgTitle: "الكتابة", description: "بواسطة مؤلفين منشورين", title: "ورشة الكتابة الإبداعية", free: "مدفوع", viewMore: "عرض المزيد" },
        13: { imgTitle: "العلوم", description: "بواسطة معلمي العلوم", title: "مقدمة في علم الفلك", free: "مدفوع", viewMore: "عرض المزيد" },
        14: { imgTitle: "المالية", description: "بواسطة مستشارين ماليين", title: "إدارة التمويل الشخصي", free: "مدفوع", viewMore: "عرض المزيد" },
        15: { imgTitle: "الفن", description: "بواسطة فنانين محترفين", title: "تقنيات الرسم الزيتي", free: "مدفوع", viewMore: "عرض المزيد" },
        16: { imgTitle: "البرمجة", description: "بواسطة خبراء الكود", title: "دليل شامل لـ React.js", free: "مدفوع", viewMore: "عرض المزيد" },
        17: { imgTitle: "الأعمال", description: "بواسطة خبراء الإدارة", title: "تطوير مهارات القيادة", free: "مدفوع", viewMore: "عرض المزيد" },
        18: { imgTitle: "التصميم", description: "بواسطة خبراء التصميم", title: "تقنيات الفوتوشوب المتقدمة", free: "مدفوع", viewMore: "عرض المزيد" },
        19: { imgTitle: "التطوير", description: "بواسطة سحرة الويب", title: "تطوير ويب متكامل Full-Stack", free: "مدفوع", viewMore: "عرض المزيد" },
        20: { imgTitle: "التسويق", description: "بواسطة مختصي SEO", title: "استراتيجيات SEO متقدمة", free: "مدفوع", viewMore: "عرض المزيد" }
    }
} 
